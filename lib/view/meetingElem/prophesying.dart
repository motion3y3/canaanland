...
class ProphesyingCard extends StatefulWidget {
  final String title;
  final String? time;
  final String? day;

  const ProphesyingCard({
    Key? key,
    required this.title,
    this.time,
    this.day,
  ...
  @override
  _ProphesyingCardState createState() => _ProphesyingCardState();
}

class _ProphesyingCardState extends State<ProphesyingCard> {
